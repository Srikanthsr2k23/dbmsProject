...
$sql_ins=$conn->query("INSERT INTO teacher_tbl 
						VALUES(
							NULL,
							'$f_name',
							'$l_name' ,
...
$sql_update=$conn->query("UPDATE teacher_tbl SET
                        f_name='$f_name' ,
                        l_name='$l_name' ,
                        gender='$gender' ,
                        dob='$dob' ,
...
if($opr=="upd")
{
	$sql_upd=$conn->query("SELECT * FROM teacher_tbl WHERE teacher_id=$id");
	$rs_upd = $sql_upd->fetch_assoc();
...
<div class="container_form">
    <form method="post">
				...
				<div class="teacher_salary_pos">
					<input type="text" name="salarytxt" class="form-control" value="<?php echo $rs_upd['salary'];?>" />
				</div><br>
...
<div class="container_form">
    <form method="post">
				...
				<div class="teacher_salary_pos">
					<input type="text" name="salarytxt" class="form-control" placeholder="Salary" />
				</div><br>
