...
if ($opr == "del") {
    ...
    $del_sql = $conn->query("DELETE FROM sub_tbl WHERE sub_id=$id");
...
<table class="table table-bordered">
	...
	if(isset($_POST['searchtxt']))
        ...
        if ($key != "") {
            $sql_sel = $conn->query("SELECT * FROM sub_tbl WHERE sub_name LIKE '%$key%'");
        } else {
            $sql_sel = $conn->query("SELECT * FROM sub_tbl");
        }
    ...
    while ($row = $sql_sel->fetch_assoc()) {
        ...
        <tr>
            ...
            <td align="center"><a href="?tag=subject_entry&opr=upd&rs_id=<?php echo $row['sub_id']; ?>"
                                  title="Update"><img
                            ...
                            src="picture/update.png" height="20" alt="Update"/></a></td>
            <td align="center"><a href="?tag=view_subjects&opr=del&rs_id=<?php echo $row['sub_id']; ?>"
                                  title="Delete"><img
                            style="-webkit-box-shadow: 0px 0px 0px 0px rgba(50, 50, 50, 0.75);-moz-box-shadow:    0px 0px 0px 0px rgba(50, 50, 50, 0.75);box-shadow:         0px 0px 0px 0px rgba(50, 50, 50, 0.75);"
                            src="picture/delete.jpg" height="20" alt="Delete"/></a></td>
        </tr>
        <?php
    }
